//Квадрат
//Трикутник задано на площині координатами своїх вершин : (X1,Y1), (X2,Y2), (X3,Y3). 
//Знайти довжину L сторони квадрата мінімальної площі, в який можна вписати цей трикутник, 
//тобто щоб всі вершини трикутника знаходились всередині квадрата або на його сторонах. 
//Скласти програму SQUARE, котра за координатами вершин трикутника знаходить довжину L сторони квадрата мінімальної площі, 
//в який можна вписати цей трикутник. Врахувати такі обмеження: 10000  X1,Y1,X2,Y2,X3,Y3  10000, дійсні числа; 
//L достатньо знайти з точністю 10–4
